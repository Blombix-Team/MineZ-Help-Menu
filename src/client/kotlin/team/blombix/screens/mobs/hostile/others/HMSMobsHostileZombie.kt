...
class HMSMobsHostileZombie : Screen(Text.translatable("menu.minez_help.title.mobs.hostile.others.zombie")) {
    ...
    private fun initZombieEntity() {
        zombieEntity = ZombieEntity(EntityType.ZOMBIE, client?.world).apply {
            ...
            //equipStack(EquipmentSlot.HEAD, named(Items.IRON_HELMET, "x"))
            //equipStack(EquipmentSlot.CHEST, named(Items.IRON_CHESTPLATE, "x"))
            //equipStack(EquipmentSlot.LEGS, named(Items.IRON_LEGGINGS, "x"))
            //equipStack(EquipmentSlot.FEET, named(Items.IRON_BOOTS, "x"))
            //equipStack(EquipmentSlot.MAINHAND, named(Items.IRON_SWORD, "x"))
        }
    }
