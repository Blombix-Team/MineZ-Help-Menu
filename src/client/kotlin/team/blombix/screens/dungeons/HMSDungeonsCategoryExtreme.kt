...
import team.blombix.screens.dungeons.extreme.HMSDungeonAnemosSanctum
import team.blombix.screens.dungeons.extreme.HMSDungeonShrineOfTheDusk

class HMSDungeonsCategoryExtreme : Screen(Text.translatable("menu.minez_help.button12")) {
    ...
    override fun init() {
        ...
        val categories = listOf(
            "§cShrine Of The Dusk" to { HMSDungeonShrineOfTheDusk() },
            "§cAnemos Sanctum" to { HMSDungeonAnemosSanctum() },
        )
