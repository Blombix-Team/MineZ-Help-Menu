...
import team.blombix.screens.dungeons.hard.*

class HMSDungeonsCategoryHard : Screen(Text.translatable("menu.minez_help.button12")) {
    ...
    override fun init() {
        ...
        addDrawableChild(ButtonWidget.builder(Text.translatable("menu.minez_help.wiki")) {
            Util.getOperatingSystem().open("https://wiki.shotbow.net/Category:MineZ_Dungeons")
        ...
        val categories = listOf(
            "§eAeternalis Crypt" to { HMSDungeonAeternalisCrypt() },
            "§eBloodstained Abyss" to { HMSDungeonBloodstainedAbyss() },
            "§eBody Offload" to { HMSDungeonBodyOffload() },
            "§eDark Mansion" to { HMSDungeonDarkMansion() },
            "§eDevil's Respite" to { HMSDungeonDevilsRespite() },
            "§eEclipsed Headquarters" to { HMSDungeonEclipsedHeadquarters() },
            "§eEclipsed Ruins" to { HMSDungeonEclipsedRuins() },
            "§eKrubera Vault" to { HMSDungeonKruberaVault() },
            "§eLost Thieves Guild" to { HMSDungeonLostThievesGuild() },
            "§eMount Therum" to { HMSDungeonMountTherum() },
            "§eNecromancer Tower" to { HMSDungeonNecromancerTower() },
            "§ePath of Light" to { HMSDungeonPathOfLight() },
            "§eSunken Mire" to { HMSDungeonSunkenMire() },
            "§eThe Undermines" to { HMSDungeonTheUndermines() },
            "§eWarped Ruins" to { HMSDungeonWarpedRuins() },
            "§eWizard Tower" to { HMSDungeonWizardTower() }
        )
    ...
    override fun render(context: DrawContext, mouseX: Int, mouseY: Int, delta: Float) {
        ...
        context.drawTextWithShadow(textRenderer, Text.translatable("menu.minez_help.menu12.title"), 0, 0, 0xFFFFFF)
        context.matrices.pop()

        val lines = textRenderer.wrapLines(
            Text.translatable("menu.minez_help.description.dungeons"),
            centerPanelWidth - 20
        )
