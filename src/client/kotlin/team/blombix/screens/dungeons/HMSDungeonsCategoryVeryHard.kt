...
import team.blombix.screens.dungeons.veryhard.*


class HMSDungeonsCategoryVeryHard : Screen(Text.translatable("menu.minez_help.button12")) {
    ...
    override fun init() {
        ...
        val categories = listOf(
            "§6Byesford Labs" to { HMSDungeonByesfordLabs() },
            "§6Frostbain Catacombs" to { HMSDungeonFrostbainCatacombs() },
            "§6Ghost Fleet" to { HMSDungeonGhostFleet() },
            "§6Paluster Shrine" to { HMSDungeonPalusterShrine() },
            "§6St. Roseluck Crypt" to { HMSDungeonStRoseluckCrypt() },
            "§6Sunken Library" to { HMSDungeonSunkenLibrary() }
        )
