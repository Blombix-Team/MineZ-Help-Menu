...
import team.blombix.screens.dungeons.insane.HMSDungeonDCS
import team.blombix.screens.dungeons.insane.HMSDungeonZD

class HMSDungeonsCategoryInsane : Screen(Text.translatable("menu.minez_help.button12")) {
    ...
    override fun init() {
        ...
        val categories = listOf(
            "§5Desert Canyon Sanctuary" to { HMSDungeonDCS() },
            "§5Zerbia Depths" to { HMSDungeonZD() },
        )
