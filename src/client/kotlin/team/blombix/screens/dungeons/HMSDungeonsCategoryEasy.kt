...
import team.blombix.screens.dungeons.easy.*

class HMSDungeonsCategoryEasy : Screen(Text.translatable("menu.minez_help.button12")) {
    ...
    override fun init() {
        ...
        val categories = listOf(
            "§bAbandoned Mineshaft" to { HMSDungeonAbandonedMineshaft() },
            "§bBell Bunker" to { HMSDungeonBellBunker() },
            "§bCarmi Sewers" to { HMSDungeonCarmiSewers() },
            "§bHerbalist's Hideout" to { HMSDungeonHerbalistsHideout() },
            "§bOrlop Deck" to { HMSDungeonOrlopDeck() },
            "§bSerpent's Hold" to { HMSDungeonSerpentsHold() },
            "§bThieves Guild" to { HMSDungeonThievesGuild() }
        )
