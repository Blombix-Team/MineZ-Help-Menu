...
import team.blombix.screens.dungeons.moderate.*

class HMSDungeonsCategoryModerate : Screen(Text.translatable("menu.minez_help.button12")) {
    ...
    override fun init() {
        ...
        val categories = listOf(
            "§2Alchemical Lab" to { HMSDungeonAlchemicalLab() },
            "§2Anvalia Mines" to { HMSDungeonAnvaliaMines() },
            "§2Arid Temple" to { HMSDungeonAridTemple() },
            "§2Asindia Ruins" to { HMSDungeonAsindiaRuins() },
            "§2Flooded Tunnels" to { HMSDungeonFloodedTunnels() },
            "§2Maze of the Tenth" to { HMSDungeonMazeOfTheTenth() },
            "§2Red Demon Temple" to { HMSDungeonRedDemonTemple() },
            "§2Excavation Site" to { HMSDungeonExcavationSite() }
        )
