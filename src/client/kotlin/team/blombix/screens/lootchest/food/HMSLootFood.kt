...
class HMSLootFood : Screen(Text.translatable("menu.minez_help.button2")) {
    ...
    override fun init() {
        ...
        addDrawableChild(ButtonWidget.builder(Text.translatable("menu.minez_help.wiki")) {
            Util.getOperatingSystem().open("https://wiki.shotbow.net/Loot_Chests#Food_Chests")
    ...
    override fun render(context: DrawContext, mouseX: Int, mouseY: Int, delta: Float) {
        ...
        context.drawTextWithShadow(
            textRenderer,
            Text.translatable("menu.minez_help.title.loot.chests.food"),
            0,
            0,
            0xFFFFFF
        )
        ...
        val lines = textRenderer.wrapLines(
            Text.translatable("menu.minez_help.description.loot.chests.food"),
