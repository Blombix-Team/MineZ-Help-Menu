...
class HelpMenuScreenRecipes : Screen(Text.translatable("menu.minez_help.button9")) {
    ...
    override fun init() {
        MineZHelpMenuClient.NavigationState.lastScreenFactory = { HelpMenuScreenRecipes() }
    ...
    override fun render(context: DrawContext, mouseX: Int, mouseY: Int, delta: Float) {
        ...
        context.drawTextWithShadow(textRenderer, Text.translatable("menu.minez_help.menu9.title"), 0, 0, 0xFFFFFF)
