...
class HelpMenuScreenHealing : Screen(Text.translatable("menu.minez_help.button2")) {
    ...
    override fun init() {
        MineZHelpMenuClient.NavigationState.lastScreenFactory = { HelpMenuScreenHealing() }
    ...
    override fun render(context: DrawContext, mouseX: Int, mouseY: Int, delta: Float) {
        ...
        context.drawTextWithShadow(textRenderer, Text.translatable("menu.minez_help.menu3.title"), 0, 0, 0xFFFFFF)
