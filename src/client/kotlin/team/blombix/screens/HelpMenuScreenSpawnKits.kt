...
class HelpMenuScreenSpawnKits : Screen(Text.translatable("menu.minez_help.button5")) {
    ...
    override fun init() {
        MineZHelpMenuClient.NavigationState.lastScreenFactory = { HelpMenuScreenSpawnKits() }
    ...
    override fun render(context: DrawContext, mouseX: Int, mouseY: Int, delta: Float) {
        ...
        context.drawTextWithShadow(textRenderer, Text.translatable("menu.minez_help.menu5.title"), 0, 0, 0xFFFFFF)
        context.matrices.pop()

        val lines = textRenderer.wrapLines(
            Text.translatable("menu.minez_help.description.spawnkit"),
