...
class HelpMenuScreenMineZLoreQuestlines : Screen(Text.translatable("menu.minez_help.button15")) {
    ...
    override fun init() {
        MineZHelpMenuClient.NavigationState.lastScreenFactory = { HelpMenuScreenMineZLoreQuestlines() }
    ...
    override fun render(context: DrawContext, mouseX: Int, mouseY: Int, delta: Float) {
        ...
        context.drawTextWithShadow(textRenderer, Text.translatable("menu.minez_help.menu15.title"), 0, 0, 0xFFFFFF)
        context.matrices.pop()

        val lines = textRenderer.wrapLines(
            Text.translatable("menu.minez_help.description.lore"),
