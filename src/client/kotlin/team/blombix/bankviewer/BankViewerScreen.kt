...
class BankViewerScreen : Screen(Text.literal("Bank Viewer")) {
    ...
    private var hoveredCount: Int = 0
    ...
    override fun render(context: DrawContext, mouseX: Int, mouseY: Int, delta: Float) {
        ...
        when {
            selectedBankType == null -> renderAggregate(context, x, y, w, h, mouseX, mouseY, delta)
            selectedPage == null -> renderOverview(context, x, y, w, h)
            else -> renderPage(context, x, y, w, h, mouseX, mouseY, delta)
        }
    ...
    private fun renderAggregate(
        ...
        context.drawText(textRenderer, Text.literal("Aggregate summary:"), x, y, 0xFFFFFF, false)
        val cols = 8
        val slot = 20
    ...
    private fun renderPage(
        ...
        context.drawText(textRenderer, Text.literal("$bank - Page $page (${items.size} items)"), x, y, 0xFFFFFF, false)
        var idx = 0
        val startY = y + 14
        for (rec in items) {
            val stack = BankStorageManager.itemRecordToItemStack(rec)
